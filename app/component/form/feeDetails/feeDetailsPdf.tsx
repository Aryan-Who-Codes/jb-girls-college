...
export const FeeDetailsPdf: React.FC<FeeItemDetails> = ({
  note,
  discount,
  taxRate,
  items,
    ...
    <View>
      <View style={pdfUtils.flexRowItemCenter}>
        <View style={{ flex: 1, paddingHorizontal: 40, paddingVertical: 16 }}>
          <Text style={pdfTypography.title}>Payment Breakdown</Text>
        </View>
        <View
          style={{
            flex: 1,
        ...
        >
          <View style={{ flex: 1 }}>
            <Text style={pdfTypography.title}>Install...</Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text style={pdfTypography.title}>Fees</Text>
          </View>
