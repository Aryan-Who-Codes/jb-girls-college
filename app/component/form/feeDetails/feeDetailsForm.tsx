  ...
  return (
    <Controller
      render={({ field: { onChange, value } }) => (
        <div className="pt-24">
          <p className="text-2xl font-semibold pb-3">Fee Details</p>
          <div className="flex flex-col gap-6">
            <div>
              <p className="pt-3 font-medium text-neutral-500">
                Select a currency for the receipt
              </p>
              <CurrencyInput />
            </div>
            <div>
              <p className="py-3 font-medium text-sm text-neutral-500">Payment Breakdown</p>
              {value.map(
              ...
              <div className="py-3 border-dashed border-b border-gray-300">
                <button
                  ...
                  type="button"
                  className="flex justify-center items-center text-indigo-500 font-medium text-sm gap-2"
                >
