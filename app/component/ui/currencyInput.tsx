      ...
      render={({ field: { onChange, value } }) => {
        ...
        return (
          <div className="flex group items-center  relative h-[52px]">
            <Popover open={open} onOpenChange={setOpen}>
              ...
              <PopoverContent className="w-full p-0 PopoverContent mt-3">
                <Command className="rounded-lg border shadow-md md:min-w-[450px]">
                  <CommandInput placeholder="Search for currency..." className="peer block w-full border-0 py-1.5 text-gray-900 focus:ring-0 sm:text-sm sm:leading-6 placeholder:text-neutral-700/40 placeholder:font-medium caret-indigo-500" />
                  <CommandList>
            ...
            <div
              className={`absolute inset-x-0 bottom-0 border-t border-gray-300  group-focus:border-t border-dashed ${open ? "border-indigo-500" : "group-hover:border-neutral-400"
                }`}
              aria-hidden="true"
            />
          </div>
